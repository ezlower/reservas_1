@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Hotel Perla del Lago')])
                    ...
                    <div class="card-body">
                        ...
                        <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="{{ __('admin@material.com') }}"
                       ...
                       <!-- <div class="bmd-form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                            <div class="input-group">
                                ...
                                <input type="username" name="username" class="form-control" placeholder="{{ __('Username or Email') }}"
